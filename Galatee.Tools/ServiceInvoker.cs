...
namespace Galatee.Tools
{
    public class ServiceInvoker
    {
        ...
        public ServiceInvoker(Uri webServiceUri) : this(webServiceUri, null)
        {
        }
        ...
        public ServiceInvoker(Uri webServiceUri, NetworkCredential credentials)
        {
        ...
        private Assembly BuildAssemblyFromWSDL(Uri webServiceUri)
        {
            ...
            return CompileAssembly(generator);//CompileAssembly(descriptionImporter);
        }
