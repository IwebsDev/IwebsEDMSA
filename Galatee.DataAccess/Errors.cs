...
namespace Galatee.DataAccess
{
    ...
    {
        public  void LogException(object pModule, Exception ex)
        {
            try
            {
        ...
        public  void WriteInLogFile(object pModule, string pError)
        {
            try
            {
        ...
        public  void WriteInLogFileFromWeb(object pModule, string methodName, string pError)
        {
            try
            {
        ...
        private  string CreateTraceFile(string pModule, string pChemin)
        {
            try
            {
        ...
        public  void WriteInLogFile(string pModule, string pError, string pChemin)
        {
            try
            {
        ...
        private  void WriteLog(string message, string pCheminFichier)
        {
            try
            {
