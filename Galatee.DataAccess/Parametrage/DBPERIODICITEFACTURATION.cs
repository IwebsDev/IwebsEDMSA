...
{
    public class DBPERIODICITEFACTURATION 
    {
        /*
        ...
        */
        ...
        public List<CsPeriodiciteFacturation> SelectAllPeriodeFacturation()
        {
            try
            {
                return Entities.GetEntityListFromQuery<CsPeriodiciteFacturation>(ParamProcedure.PARAM_PERIODICITEFACTURATION_RETOURNE());
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public bool Delete(CsPeriodiciteFacturation pEntity)
        {
            try
            {
                return Entities.DeleteEntity<Galatee.Entity.Model.PERIODICITE>(Entities.ConvertObject<Galatee.Entity.Model.PERIODICITE, CsPeriodiciteFacturation>(pEntity));
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public bool Delete(List<CsPeriodiciteFacturation> pEntityCollection)
        {
            try
            {
                return Entities.DeleteEntity<Galatee.Entity.Model.PERIODICITE>(Entities.ConvertObject<Galatee.Entity.Model.PERIODICITE, CsPeriodiciteFacturation>(pEntityCollection));
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public bool Update(CsPeriodiciteFacturation pEntity)
        {
            try
            {
                return Entities.UpdateEntity<Galatee.Entity.Model.PERIODICITE>(Entities.ConvertObject<Galatee.Entity.Model.PERIODICITE, CsPeriodiciteFacturation>(pEntity));
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public bool Update(List<CsPeriodiciteFacturation> pEntityCollection)
        {
            try
            {
                return Entities.UpdateEntity<Galatee.Entity.Model.PERIODICITE>(Entities.ConvertObject<Galatee.Entity.Model.PERIODICITE, CsPeriodiciteFacturation>(pEntityCollection));
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public bool Insert(CsPeriodiciteFacturation pEntity)
        {
            try
            {
                return Entities.InsertEntity<Galatee.Entity.Model.PERIODICITE>(Entities.ConvertObject<Galatee.Entity.Model.PERIODICITE, CsPeriodiciteFacturation>(pEntity));
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public bool Insert(List<CsPeriodiciteFacturation> pEntityCollection)
        {
            try
            {
                return Entities.InsertEntity<Galatee.Entity.Model.PERIODICITE>(Entities.ConvertObject<Galatee.Entity.Model.PERIODICITE, CsPeriodiciteFacturation>(pEntityCollection));
            }
            catch (Exception ex)
            {
                throw ex;
