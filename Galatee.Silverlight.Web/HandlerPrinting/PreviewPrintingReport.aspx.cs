...
{
    public partial class PreviewPrintingReport : System.Web.UI.Page
    {
            ...
            try
            {
                if (!Page.IsPostBack)
                {
                    ...
                    try
                    {
                        ...
                        GalateePreview.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Remote;
