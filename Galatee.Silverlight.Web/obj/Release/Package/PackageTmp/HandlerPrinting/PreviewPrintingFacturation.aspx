<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PreviewPrintingFacturation.aspx.cs" Inherits="Galatee.Silverlight.Web.PreviewPrintingFacturation" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function CloseFrame() {
            ...
            try {
                ...
                parent.document.getElementById("FacturationDIV_IFRAME").style.display = "none";
