<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PreviewPrintingCaisse.aspx.cs" Inherits="Galatee.Silverlight.Web.PreviewPrintingCaisse" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function CloseFrame() {
            ...
            try {
                ...
                parent.document.getElementById("CaisseDIV_IFRAME").style.display = "none";
