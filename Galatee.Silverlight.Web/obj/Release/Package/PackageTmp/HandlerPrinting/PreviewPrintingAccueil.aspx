<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PreviewPrintingAccueil.aspx.cs" Inherits="Galatee.Silverlight.Web.PreviewPrintingAccueil" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function CloseFrame() {
            ...
            try {
                ...
                parent.document.getElementById("AccueilDIV_IFRAME").style.display = "none";
            } catch (e) {
