<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PreviewPrintingParametrage.aspx.cs" Inherits="Galatee.Silverlight.Web.PreviewPrintingParametrage" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function CloseFrame() {
            ...
            try {
                ...
                parent.document.getElementById("ParametrageDIV_IFRAME").style.display = "none";
