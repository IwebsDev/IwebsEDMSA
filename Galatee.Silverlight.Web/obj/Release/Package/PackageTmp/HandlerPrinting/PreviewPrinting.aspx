<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PreviewPrinting.aspx.cs" Inherits="Galatee.Silverlight.Web.PreviewPrinting" %>
...
// <![CDATA[
        ...
        function CloseFrame() {
            ...
            try {
                ...
                parent.document.getElementById("RecouvrementDIV_IFRAME").style.display = "none";
...
<%--        <div class="fieldhead" style=" width:350px; ">Grouping text </div>
        <div  id="PanelCritere" style=" border-bottom:solid 1px lightgray" >
        <table style="width: 80%; ">
            <tr>
                <td class="style1">
                    <asp:PlaceHolder ID="Ucontainer" runat="server"></asp:PlaceHolder>
                </td >
                <td >
                    <asp:Button ID="btnApercu" runat="server" Text="Apercu" 
                        onclick="btnApercu_Click"  ValidationGroup="valider"/>
                </td>
            </tr>
        </table>
   </div> 
        <br />
     <div class="fieldhead" style=" width:350px; ">Preview</div>--%>
        <div >  
      ...
      <%--  <asp:Panel  GroupingText="Aperçu" ID="PanelViewer" runat="server" style="Width:90%;height:100%; border:none;">
