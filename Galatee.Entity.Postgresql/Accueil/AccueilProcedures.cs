...
namespace Galatee.Entity.Model
{
    public static class AccueilProcedures
    {
        ...
        public static void InitConnectionString()
        {
            try
            {
                ConnectionString = GetSqlConnexionString();
            }
            catch (Exception)
            {
                throw;
        ...
        public static DataTable RechercherLocalisation(int Fk_idcentre, string Centre, string pTournee,
            string pOrdreTourne, string pProduit, string pRue, string pPorte, string pLot, string pLongitude, string pLatitude)
        {
            try
            {
                galadbEntities context = new galadbEntities();
        ...
        public static DataTable RechercherClientNumeroDeFacture(string  Periode, string Facture)
        {
            try
            {
                galadbEntities context = new galadbEntities();
                ...
                query =
                from _LeClient in _CLIENT
                from _Facture in _LeClient.LCLIENT 
                where (string.IsNullOrEmpty(Periode) ||  _Facture.REFEM == Periode ) &&
                      (string.IsNullOrEmpty(Facture) || _Facture.NDOC == Facture)
                group new { _LeClient }
                by new { _LeClient.CENTRE, _LeClient.REFCLIENT, _LeClient.ORDRE, _LeClient.NOMABON,_LeClient.FK_IDCENTRE   } into pTemp3
                select new
                {
        ...
        public static DataTable RetourneAbon(int fk_idClient)
        {
            try
            {
                using (galadbEntities context = new galadbEntities())
                {
                    ...
                    from _LeClient in _LeAg.CLIENT1
                    from _LeAbon in _LeClient.ABON
                    where _LeClient.PK_ID == fk_idClient 
                    select new
                    {
                        _LeAbon.CENTRE,
                        _LeAbon.CLIENT,
        ...
        public static DataTable RetourneClient(int fk_idcentre, string pCentre, string pClient, string pOrdre)
        {
            try
            {
                using (galadbEntities context = new galadbEntities())
                {
                    ...
                    IEnumerable<object> query = null;
                    var _CLIENT = context.CLIENT;
                    //var _REGROUPEMENT = context.REGROUPEMENT;
                  
                        query =
                        from _LeCLIENT in _CLIENT
                        //join _LeREGROUPEMENT in _REGROUPEMENT on _LeCLIENT.REGROUPEMENT equals _LeREGROUPEMENT.CODE
                        where
                              _LeCLIENT.FK_IDCENTRE == fk_idcentre &&
                              _LeCLIENT.CENTRE == pCentre &&
        ...
        public static DataTable RetourneCanalisationClasseur(int fk_idcentre, string pCentre, string pClient,int fk_idabon, string pProduit, int? pPoint)
        {
            try
            {
                using (galadbEntities context = new galadbEntities())
                {
                    ...
                    _LeCANALISATION.CENTRE == pCentre &&
                          _LeCANALISATION.CLIENT == pClient &&
                          _LeCANALISATION.FK_IDCENTRE == fk_idcentre &&
                          //_LeCANALISATION.FK_IDABON == fk_idabon &&
                    (string.IsNullOrEmpty(pProduit) || _LeCANALISATION .PRODUIT == pProduit) &&
                    (string.IsNullOrEmpty(point) || _LeCANALISATION.POINT == pPoint)
                    select new
                    {
        ...
        public static DataTable RetourneCanalisation(int fk_idcentre, string pCentre, string pClient, string pProduit)
        {
            try
            {
                using (galadbEntities context = new galadbEntities())
        ...
        public static DataTable RetourneEvenementDuCompteur(int fk_idCannalisation)
        {
            try
            {
                using (galadbEntities context = new galadbEntities())
                {
                    ...
                    (from _LeEVENEMENT in _EVENEMENT
                     where _LeEVENEMENT.FK_IDCANALISATION == fk_idCannalisation 
                     select new
                     {
                         _LeEVENEMENT.CENTRE,
                         _LeEVENEMENT.CLIENT,
       ...
       public static DataTable RetourneScellageCompteur(string numero,string marque)
        ...
        public static DataTable RetourneDemandeClientType(string pCentre, string pClient, string pOrdre,int pIdCentre, string pTdem)
        {
            try
            {
                using (galadbEntities context = new galadbEntities())
                {
                    IEnumerable<object> query = null;
                    var _DEMANDE = context.DEMANDE;
                    var _DemaneWkf= context.DEMANDE_WORFKLOW ;
                    query =
                    from p in _DEMANDE
                    join w in  _DemaneWkf on p.NUMDEM equals w.CODE_DEMANDE_TABLETRAVAIL 
                    where
                           (p.CENTRE == pCentre )
                        && (p.CLIENT == pClient )
                        ...
                        && (w.FK_IDSTATUS != 6 && w.FK_IDSTATUS != 4) 
        ...
        public static DataTable RetourneListeDemandeCritere_(int? pCentre, string pNumdem, List<string> LstTdem, DateTime? pDatedebut, DateTime? pDateFin,
                                DateTime? pDatedemande, string pNumerodebut, string pNumerofin, string pStatus, string Commune, string Quatier, string Secteur, string Rue, string Porte, string Etage, string NumeroLot, string Compteur, string Nom)
        {
            //cmd.CommandText = "SPX_GUI_RETOURNE_DABON";
            try
            {
                ...
                {
                    IEnumerable<object> query = null;
                    var _AG = context.DAG.AsQueryable();
                    if (!string.IsNullOrWhiteSpace(Commune))
                    {
                        _AG = _AG.Where(a => a.COMMUNE == Commune);
                    }
                    if (!string.IsNullOrWhiteSpace(Quatier))
                    {
                        _AG = _AG.Where(a => a.QUARTIER == Quatier);
                    } 
                    if (!string.IsNullOrWhiteSpace(Secteur))
                    {
                        _AG = _AG.Where(a => a.SECTEUR == Secteur);
                    }
                    if (!string.IsNullOrWhiteSpace(Rue))
                    {
                        _AG = _AG.Where(a => a.RUE == Rue);
                    } 
                    if (!string.IsNullOrWhiteSpace(Porte))
                    {
                        _AG = _AG.Where(a => a.PORTE == Porte);
                    }
                    if (!string.IsNullOrWhiteSpace(Etage))
                    {
                        _AG = _AG.Where(a => a.ETAGE == Etage);
                    } 
                    if (!string.IsNullOrWhiteSpace(NumeroLot))
                    {
                        _AG = _AG.Where(c => c.CLIENT == context.DCLIENT.FirstOrDefault(a => a.NUMPROPRIETE == NumeroLot).REFCLIENT);
                    }
                    var _DEMANDE = context.DEMANDE;
                    var _DEMANDEwkf = context.DEMANDE_WORFKLOW;
                    //var AG = _AG.AsQueryable();
                    var _wkfEtap = context.ETAPE ;
                    if (_AG != null && _AG.Count()>0)
                    {
                        query =
                    from p in _DEMANDE
                    join wk in _DEMANDEwkf on p.NUMDEM equals wk.CODE_DEMANDE_TABLETRAVAIL
                    join a in _AG on p.PK_ID equals a.FK_IDDEMANDE
                    where
                        (p.NUMDEM == pNumdem || string.IsNullOrEmpty(pNumdem))
                    && (p.FK_IDCENTRE == pCentre || pCentre == null)
                    && (LstTdem.Count == 0 || LstTdem.Contains(p.TYPEDEMANDE))
        ...
        public static DataTable GetDemandeByNumIdDemande(int pNumEtape)
        {
            try
            {
                using (galadbEntities context = new galadbEntities())
                {
                    ...
                    //join dw in context.DEMANDE_WORFKLOW on new { P.NUMDEM, P.FK_IDCENTRE } equals new { NUMDEM = dw.CODE_DEMANDE_TABLETRAVAIL, dw.FK_IDCENTRE }
                    join dw in context.DEMANDE_WORFKLOW on SqlFunctions.StringConvert((double)P.PK_ID).Trim() equals dw.FK_IDLIGNETABLETRAVAIL
                    orderby
                      P.NUMDEM descending
                    ...
                    select new
                    {
                        ...
                        P.DATEMODIFICATION,
                        P.USERMODIFICATION,
                        ETAPEDEMANDE=dw.FK_IDETAPEACTUELLE,
                        P.ISSUPPRIME,
                        P.USERSUPPRESSION,
                        P.DATESUPPRESSION,
                        P.PK_ID,
        ...
        public static DataTable GetDemandeByNumDemande(string  pNumDemande)
        {
            try
            {
                using (galadbEntities context = new galadbEntities())
        ...
        //        if (_LeseltDevis != null && _LeseltDevis.Count != 0 && LstEntite != null && LstEntite.Count != 0)
        //        {
        //            LstEntite.ForEach(t => t.FK_IDDEMANDE = _LaDemandeExiste.PK_ID);
        //            Resultat = Entities.InsertEntity<ELEMENTDEVIS>(LstEntite, pContext);
        //        }
        ...
        public static bool MisAjourDetailDemande(DEMANDE _LaDemandeExiste, List<RUBRIQUEDEMANDE> LstEntite, galadbEntities pContext)
        {
            try
            {
                ...
                {
                    var rubrique = Context1.RUBRIQUEDEMANDE.Where(p => p.NUMDEM == _LaDemandeExiste.NUMDEM && p.FK_IDDEMANDE == _LaDemandeExiste.PK_ID);
                    if (rubrique != null && rubrique.Count() != 0)
                        Resultat = Entities.UpdateEntity<RUBRIQUEDEMANDE>(item, pContext) && Resultat;
                    else
                    {
                        LstEntite.ForEach(t => t.FK_IDDEMANDE = _LaDemandeExiste.PK_ID);
                        Resultat = Entities.InsertEntity<RUBRIQUEDEMANDE>(item, pContext) && Resultat;
                    }
                }
                return Resultat;
            }
        ...
        public static  LCLIENT  RetourneLaFactureDemande(CsDemandeDetailCout FactureAregle)
        {
            try
            {
                galadbEntities ctxInter = new galadbEntities();
        ...
        public static string GetNumDemande(CsDemandeBase entity)
        {
            try
            {
                return  DateTime.Today.Year.ToString().Substring(2,2) + DateTime.Today.Month.ToString("00") + DateTime.Today.Day  + DateTime.Today.Minute.ToString("00") + DateTime.Today.Second.ToString("00") + DateTime.Today.Millisecond.ToString("00") + entity.MATRICULE ;
            }
            catch (Exception ex)
            {
                throw ex;
            ...
            try
            {
               string  pNumeroDevis = string.Empty;
                ...
                if (devisenBase != null && !string.IsNullOrWhiteSpace( devisenBase.CODE) )
                {
                    ...
                    if (devisenBase.NUMERODEMANDE == null)
                        devisenBase.NUMERODEMANDE = 0;
        ...
        public static string GetReferenceClient(CsDemandeBase entity)
        {
            string NumeroDepartReference = "1";
            try
            {
                string pNumeroDevis = string.Empty;
                galadbEntities context = new galadbEntities();
                ...
                {
                    string CodeSite = devisenBase.SITE.CODE;
                    if (devisenBase.REFERENCECLIENT == null) devisenBase.REFERENCECLIENT = 0;
                    int numDevis = (devisenBase.REFERENCECLIENT .Value + 1);
                    if (numDevis > 0)
                    {
                        pNumeroDevis = numDevis.ToString().PadLeft(5, '0');
                        NumeroDepartReference = entity.CENTRE + CodeSite + pNumeroDevis;
                    }
                    devisenBase.REFERENCECLIENT++;
                    context.SaveChanges();
                }
                context.Dispose();
                return NumeroDepartReference;
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public static string GetReferenceClientMT(CsDemandeBase entity)
        {
            string NumeroDepartReference = "1";
            try
            {
                ...
                if (devisenBase != null && !string.IsNullOrWhiteSpace(devisenBase.CODE))
                {
                    ...
                    {
                        pNumeroDevis = numDevis.ToString().PadLeft(5, '0');
                        NumeroDepartReference = "920" + entity.CENTRE + pNumeroDevis;
                    }
                    devisenBase.REFERENCECLIENT++;
                    context.SaveChanges();
                }
            ...
            try
            {
                ...
                List<DEVENEMENT> _LstEvenement = new List<DEVENEMENT>();
                {
                    ...
                    { 
                        ...
                        foreach (DEVENEMENT item in _LstEvenement)
                        {
                          CASIND leCas =  _LeContextInter.CASIND.FirstOrDefault(c=>c.CODE==item.CAS);
                          if (leCas != null)
                              item.FK_IDCAS = leCas.PK_ID;
                        }
                    }
                    if (IsUpdate)
                    {
                ...
                if (IsUpdate)
                {
                    //new ErrorManager().WriteInLogFile(this, "debogue ");
                    ...
                    {
                        var doc = pContext.DOCUMENTSCANNE.Where(d => d.FK_IDDEMANDE == pDemande.LaDemande.PK_ID);
                        if (doc != null && doc.Count() > 0)
                        {
                            Entities.DeleteEntity<Galatee.Entity.Model.DOCUMENTSCANNE>(doc.ToList(), pContext);
                        }
                        foreach (ObjDOCUMENTSCANNE item in pDemande.ObjetScanne)
                        {
                            ...
                            //if (leDoc != null)
                            //{
                            //    pContext.DOCUMENTSCANNE.Remove(leDoc);
                            //}
                            item.FK_IDDEMANDE = _LaDemandeExiste.PK_ID;
                    ...
                    if (string.IsNullOrEmpty(_Demande.NUMDEM))
                    {
                        ...
                        //_Demande.CLIENT  = GetNumDevis(pDemande.LaDemande);
                        ...
                        {
                            if (string.IsNullOrEmpty(_Demande.CLIENT))
                            {
                                if (_Demande.PRODUIT == Enumere.ElectriciteMT)
                                    _Demande.CLIENT = pDemande.LaDemande.CLIENT = GetReferenceClientMT(pDemande.LaDemande);
                                else
                                    _Demande.CLIENT = pDemande.LaDemande.CLIENT = GetReferenceClient(pDemande.LaDemande);
                            }
                        }
                    ...
                    DANNOTATION leAno = new DANNOTATION();
                    MiseTableTemp(pDemande, _LaDemandeExiste, _LeClient,
                                  ...
                                  leAno, _LeDepannage, _LaPersonnePhysique, _LaSocietePrive,
                ...
                else
                {
                    ...
                    if (string.IsNullOrEmpty(_Demande.NUMDEM))
                    {
                        ...
                        if (_Demande.TYPEDEMANDE == Enumere.BranchementAbonement ||
                                     ...
                                     _Demande.TYPEDEMANDE == Enumere.BranchementAbonnementMt ||
                                     _Demande.TYPEDEMANDE == Enumere.BranchementAbonementExtention ||
                                     _Demande.TYPEDEMANDE == Enumere.ChangementProduit   ||
                                     _Demande.TYPEDEMANDE == Enumere.BranchementAbonnementEp)
                        {
                            if (string.IsNullOrEmpty(_Demande.CLIENT))
                            {
        ...
        public static void MiseAjoursAbonBrtAbonnement(CsDemande pDemande, galadbEntities pContext)
        {
            try
            {
                ...
                {
                    _LeCompteur = Entities.ConvertObject<CANALISATION, CsCanalisation>(pDemande.LstCanalistion);
                    _LeCompteur.ForEach(t => t.PROPRIO = Enumere.LOCATAIRE );
                    _LeCompteur.ForEach(t => t.FK_IDPROPRIETAIRE = pContext.PROPRIETAIRE.FirstOrDefault(p => p.CODE == Enumere.LOCATAIRE).PK_ID);
                }
                ...
                List<LCLIENT> _LstFacture = new List<LCLIENT>();
                if (pDemande.LstCoutDemande != null && pDemande.LstCoutDemande.Count != 0 && pDemande.LaDemande.ISPASSERCAISSE != true )
                {
                    if (pDemande.LaDemande.TYPEDEMANDE != Enumere.BranchementAbonnementEp)
                    {
                        foreach (CsDemandeDetailCout item in pDemande.LstCoutDemande)
                ...
                List<LCLIENT> lstSansCaisseFacture = new List<LCLIENT>();
                if (pDemande.LstCoutDemande != null && pDemande.LstCoutDemande.Count != 0 && pDemande.LaDemande.ISPASSERCAISSE == true)
                {
                    foreach (CsDemandeDetailCout item in pDemande.LstCoutDemande)
                    {
                        ...
                        lstSansCaisseFacture.Add(RetourneLaFactureDemande(item));
                    }
                    lstSansCaisseFacture.ForEach(t => t.FK_IDADMUTILISATEUR = pDemande.LaDemande.FK_IDADMUTILISATEUR);
                    lstSansCaisseFacture.ForEach(t => t.FK_IDCLIENT = _LeClient.PK_ID);
                    Entities.InsertEntity<LCLIENT>(lstSansCaisseFacture, pContext);
                }
                List<POSE_SCELLE_DEMANDE> organeScelleDemande = new List<POSE_SCELLE_DEMANDE>();
                if (pDemande.LaDemande != null)
                {
        ...
        public static bool MiseAjoursApDp(CsDemande pDemande, galadbEntities pContext)
        {
            try
            {
                ...
                if (_LeAbon != null)
                {
                    ...
                    _LeAbon.PUISSANCE  = pDemande.Abonne.PUISSANCE.Value  ;
        ...
        public static void MiseAjoursTransfertSiteNonMigre2(CsDemande pDemande, galadbEntities pContext)
        {
            ...
            try
            {
                ...
                if (pDemande.LstCanalistion != null)
                {
                    _LeCompteur = Entities.ConvertObject<CANALISATION, CsCanalisation>(pDemande.LstCanalistion);
                    _LeCompteur.ForEach(t => t.PROPRIO = Enumere.LOCATAIRE);
                    _LeCompteur.ForEach(t => t.FK_IDPROPRIETAIRE = contextinter.PROPRIETAIRE.FirstOrDefault(p => p.CODE == Enumere.LOCATAIRE ).PK_ID);
                }
                List<EVENEMENT> _LstEvenement = new List<EVENEMENT>();
                if (pDemande.LstEvenement != null)
                {
                    _LstEvenement = Entities.ConvertObject<EVENEMENT, CsEvenement>(pDemande.LstEvenement);
                    string MaxPeriode = string.Empty;
                    int MaxNum = 0;
                    List<EVENEMENT> levtMax = contextinter.EVENEMENT.Where(p => p.CENTRE == _LeAG.CENTRE && p.CLIENT == _LeAG.CLIENT && p.FK_IDCENTRE == _LeAG.FK_IDCENTRE ).OrderByDescending(p => p.PERIODE).ToList();
                    if (levtMax != null && levtMax.Count != 0)
                    {
                        MaxPeriode = levtMax.FirstOrDefault().PERIODE;
                        MaxNum = levtMax.Max(p => p.NUMEVENEMENT);
                        _LstEvenement = _LstEvenement.Where(t =>!string.IsNullOrEmpty(t.PERIODE) && int.Parse(t.PERIODE) > int.Parse(MaxPeriode)).ToList();
                        foreach (EVENEMENT  item in _LstEvenement)
                        {
                            MaxNum ++;
                            item.NUMEVENEMENT = MaxNum;
                        }
                    }
                }

                AG lag = contextinter.AG.FirstOrDefault(p => p.CENTRE ==_LeAG.CENTRE && p.CLIENT == _LeAG.CLIENT && p.FK_IDCENTRE == _LeAG.FK_IDCENTRE);
                if (lag == null)
                {
                    Entities.InsertEntity<AG>(_LeAG, pContext);
                    _LeBrt.FK_IDAG = _LeAG.PK_ID;
                    ...
                    string LeNumero = lstcompteur.FirstOrDefault().NUMERO;
                    string LaMarque = lstcompteur.FirstOrDefault().MARQUE;
                    int IdCompteur = 0;
                    COMPTEUR lesCompteur = contextinter.COMPTEUR.FirstOrDefault(o => o.NUMERO == LeNumero && o.MARQUE == LaMarque);
                    if (lesCompteur != null)
                        IdCompteur = lesCompteur.PK_ID;
                    else
                        Entities.InsertEntity<COMPTEUR>(lstcompteur, pContext);
                ...
                {
                    string Ordre = lag.CLIENT1.OrderByDescending(u=>u.ORDRE).FirstOrDefault().ORDRE ;
                    int idAbon = lag.CLIENT1.OrderByDescending(u => u.ORDRE).FirstOrDefault().ABON.FirstOrDefault().PK_ID   ;

                    ABON leAbonn = pContext.ABON.FirstOrDefault(i => i.PK_ID == idAbon);
                    if (leAbonn != null && leAbonn.DRES == null) leAbonn.DRES = System.DateTime.Today.Date;
                    string OdreActif = (int.Parse(Ordre) + 1).ToString("00");

                    _LeClient.FK_IDAG = _LeAG.PK_ID;
                    _LeClient.ORDRE = OdreActif;
                    Entities.InsertEntity<CLIENT>(_LeClient, pContext);

                    _LeAbon.FK_IDCLIENT = _LeClient.PK_ID;
                    _LeAbon.ORDRE = OdreActif;
                    Entities.InsertEntity<ABON>(_LeAbon, pContext);
                    fk_idclient = _LeClient.PK_ID;
                ...
                //if (pDemande.LstCoutDemande != null && pDemande.LstCoutDemande.Count != 0 && pDemande.LaDemande.ISPASSERCAISSE ==true )
                //{
                //    List<LCLIENT> lstFacture = new List<LCLIENT>();
                //    foreach (CsDemandeDetailCout item in pDemande.LstCoutDemande)
                //    {
                //        if (item.COPER == Enumere.CoperCAU)
                //        {
                ...
                //        }
                //        else
                //            lstFacture.Add(RetourneLaFactureDemande(item));
                //    }
                //    lstFacture.ForEach(t => t.FK_IDCLIENT = fk_idclient);
                //    lstFacture.ForEach(t => t.FK_IDADMUTILISATEUR = pDemande.LaDemande.FK_IDADMUTILISATEUR );
                //}
        ...
        //public static List<CsLclient> RetourneFactureAvanceFromAbon(int idcentre,string client,string ordre )
        //{
        //    try
        //    {
        ...
        //                cmd.CommandText = "SPX_ACC_GET_CAUTION";
        ...
        //                        var LaListeFactureAvance = Galatee.Tools.Utility.GetEntityFromQuery<CsLclient>(dt);
        //                        if (LaListeFactureAvance != null)
        //                           return LaListeFactureAvance.ToList();
        //                        return null;
        //                        //LaListeFactureAvance = LaListeFactureAvance.Where(f => f.REFEM == refem && f.MONTANT == montant);
        //                        //return Galatee.Tools.Utility.ListToDataTable(LaListeFactureAvance);
        //                    //return dt;
        //    #region Commentaire
        //                    //using (galadbEntities context = new galadbEntities())
        //                    //{
        ...
        //                        //var LaListeFactureAvance = Galatee.Tools.Utility.GetEntityFromQuery<CsLclient>(dt);
        //                        var LaListeFactureAvance = Galatee.Tools.Utility.GetEntityListFromQuery<CsLclient>(dt);
        ...
        public static DataTable RetourneAvanceFromAbon(CsClient leClient)
        {
            try
            {
                 ...
                 //       cmd.CommandType = CommandType.StoredProcedure;
                 //       cmd.CommandText = "SPX_ACC_GET_CAUTION";
                 //       cmd.Parameters.Add("@idCentre", SqlDbType.Int).Value = leClient.FK_IDCENTRE.Value;
                 //       cmd.Parameters.Add("@Client", SqlDbType.VarChar, 20).Value = leClient.REFCLIENT;
                 //       cmd.Parameters.Add("@Ordre", SqlDbType.VarChar, 2).Value = leClient.ORDRE;
        ...
        //    }
        //}
        public static bool MiseTableTemp(CsDemande laDemande, DEMANDE _LaDemandeExiste, DCLIENT Leclient, DAG Ag, DABON Abonnement, DBRT branchement,
                ...
                if (pDemande.LstCanalistion  != null)
                {
                    using (galadbEntities ctx = new galadbEntities())
                    {
                        ...
                        foreach (var _LeCompteur in _LesDCompteur)
                        {
                            ...
                            COMPTEUR Compteur = ctx.COMPTEUR.FirstOrDefault(p => p.FK_IDMARQUECOMPTEUR == _LeCompteur.FK_IDMARQUECOMPTEUR && p.NUMERO == _LeCompteur.NUMERO);
                            if (Compteur == null)
                            {
                               Compteur= Entities.ConvertObject<COMPTEUR, DCOMPTEUR>(_LeCompteur);
                               Entities.InsertEntity<COMPTEUR>(Compteur,ctx);
                            }
                            if (pDemande.LaDemande.PRODUIT == Enumere.ElectriciteMT )
                                ...
                                Compteur.MISEENSERVICE = DateTime.Now;
                                
                                
                            int id_abon=pDemande.LstCanalistion.First().FK_IDABON;
                            CANALISATION cann = ctx.CANALISATION.FirstOrDefault(c => c.FK_IDABON ==id_abon  && c.DEPOSE == null);
                            if (cann!=null)
                            {
                                cann.FK_IDCOMPTEUR = Compteur.PK_ID; 
                            }
                        }
        ...
        public static bool MiseAjoursChangementProduit1(CsDemande pDemande, galadbEntities pContext)
        {
            try
            {
                galadbEntities contextinter = new galadbEntities();
                ...
                AG leA = contextinter.AG.FirstOrDefault(t => t.FK_IDCENTRE == pDemande.LaDemande.FK_IDCENTRE && t.CENTRE == pDemande.LaDemande.CENTRE && t.CLIENT == pDemande.LaDemande.CLIENT);
                CLIENT  leClient = contextinter.CLIENT.FirstOrDefault(t => t.FK_IDCENTRE == pDemande.LaDemande.FK_IDCENTRE && t.CENTRE == pDemande.LaDemande.CENTRE && t.REFCLIENT  == pDemande.LaDemande.CLIENT);

                IdClient = leClient.PK_ID;
                IdAg = leA.PK_ID; 
                ...
                if (pDemande.LstCoutDemande != null && pDemande.LstCoutDemande.Count != 0)
                {
                    foreach (CsDemandeDetailCout item in pDemande.LstCoutDemande)
                    {
                        ...
                        if (lelClient != null && !string.IsNullOrEmpty(lelClient.CENTRE))
                        {
                            lelClient.FK_IDCLIENT = IdClient ;
                            lelClient.COPER = item.COPER;
                            lelClient.FK_IDCOPER = item.FK_IDCOPER;
                            lelClient.MONTANT = (item.MONTANTHT + item.MONTANTTAXE);
                        }
        ...
        public static void MiseAjoursChangementProduit(CsDemande pDemande, galadbEntities pContext)
        {
            try
            {
                galadbEntities contextinter = new galadbEntities();
                ...
                //CLIENT  leClientAResilier = contextinter.CLIENT.FirstOrDefault(u => u.PK_ID == pDemande.LaDemande.FK_IDCLIENT.Value );
                //if (leClientAResilier != null)
                //{
                //    CsClient leCl = Entities.ConvertObject<CsClient, CLIENT>(leClientAResilier);
                //    MiseAjoursResiliation(leCl, pDemande.LaDemande , pContext);
                //}
                ...
                foreach (EVENEMENT item in _LstEvenement.Where(t=>t.CAS == Enumere.CasPoseCompteur ).ToList())
                {
                    item.FK_IDABON = _LeAbon.PK_ID;
                    item.FK_IDCANALISATION = _LeCompteur.FirstOrDefault(t => t.POINT == item.POINT).PK_ID;
        ...
        public static DataTable RetourneAbonnementAgent(string matricule)
        {
            using (galadbEntities context = new galadbEntities())
            {
                ...
                query =
                from p in _user
                join c in context.CLIENT on p.MATRICULE equals c.MATRICULE 
                join a in context.ABON on c.PK_ID equals a.FK_IDCLIENT into pTempAgent
                from j in pTempAgent.DefaultIfEmpty()
                where p.MATRICULE == matricule && j.DRES==null
                select new
                {
                    j.CENTRE ,
                    REFCLIENT=j.CLIENT,
        ...
        public static DataTable RetourneListeGroupe()
        {
            try
            {
                ...
                using (galadbEntities context = new galadbEntities())
                {
                    ...
                    foreach (DEMANDE demande in lstDemande)
                    {
                        PROGRAMMATION prog = new PROGRAMMATION()
                        {
                            ...
                            NUMPROGRAMME = DateTime.Today.Date.Year.ToString() + DateTime.Today.Date.Month.ToString("00") + DateTime.Today.Date.Day.ToString("00") +
                                           DateTime.Today.Date.Minute.ToString("00")+DateTime.Today.Date.Second.ToString("00") + DateTime.Today.Date.Millisecond.ToString("00") + 
                                           demande.MATRICULE ,
        ...
        public static DataTable ChargerDemandeDepanage(int iddemande)
        {
            try
            {
                ...
                using (galadbEntities context = new galadbEntities())
                {
                    ...
                    //join p1 in context.GRC_PANNE on x.FK_IDTYPEDEPANNE_TRAITE equals p1.ID
                    where x.FK_IDDEMANDE == iddemande
                    select new
                    {
                      x.PK_ID ,
                      ...
                      p.PROCESVERBAL ,
                      //PANNETRAITE = x.GRC_PANNE1.LIBELLE, 
                      x.HEUREDEBUT ,
                      x.HEUREFIN ,
                      x.ISRESEAU ,
                      x.ISBRANCHEMENT ,
            ...
            try
            {
                ...
                using (galadbEntities context = new galadbEntities())
                {
                    ...
                    select new
                    {
                        ...
                        LIBELLETYPEPIECE = _LeDCLIENT.PIECEIDENTITE.LIBELLE,
                        _LeDCLIENT.ISMODIFIER ,
                        CODESITE=_LeDCLIENT.CENTRE1.SITE.CODE
            ...
            try
            {
                using (galadbEntities context = new galadbEntities())
                {
                    ...
                    select new
                    {
                        ...
                        LIBELLETYPECOMPTAGE = _LeDABON.TYPECOMPTAGE1.LIBELLE,
                        LIBELLECENTRE = _LeDABON.CENTRE1.LIBELLE,
                        LIBELLEPRODUIT = _LeDABON.PRODUIT1.LIBELLE,
                        LIBELLETARIF = _LeDABON.TYPETARIF1.LIBELLE,
                        LIBELLEFORFAIT = _LeDABON.FORFAIT1.LIBELLE,
            ...
            try
            {
                using (galadbEntities context = new galadbEntities())
                {
                    ...
                    select new
                    {
                        ...
                        TYPECOMPTEUR= (_LeCANALISATION.MAGASINVIRTUEL == null) ? string.Empty : _LeCANALISATION.MAGASINVIRTUEL.TYPECOMPTEUR.CODE   ,
                        FK_IDTYPECOMPTEUR = (_LeCANALISATION.MAGASINVIRTUEL == null || _LeCANALISATION.MAGASINVIRTUEL.TYPECOMPTEUR == null) ? 0 : _LeCANALISATION.MAGASINVIRTUEL.TYPECOMPTEUR.PK_ID,
                        ...
                        _LeCANALISATION.MAGASINVIRTUEL.MARQUE,
                        _LeCANALISATION.MAGASINVIRTUEL.MARQUECOMPTEUR,
                        _LeCANALISATION.MAGASINVIRTUEL.FK_IDMARQUECOMPTEUR,
                         LIBELLEREGLAGECOMPTEUR =_LeCANALISATION.REGLAGECOMPTEUR1.LIBELLE ,
                         CAS = Enumere.CasPoseCompteur 
                    };
                    return Galatee.Tools.Utility.ListToDataTable(query);
        ...
        //            else
        //            {
        //                _LeClient.REGROUPEMENT = null;
        //                _LeClient.FK_IDREGROUPEMENT = null;
        //            }
        ...
        //            _LeCompteur.ForEach(t => t.FK_IDABON = _LeAbon.PK_ID);
        //            _LeCompteur.ForEach(t => t.REGLAGECOMPTEUR = pDemande.LaDemande.REGLAGECOMPTEUR);
        //            _LeCompteur.ForEach(t => t.FK_IDREGLAGECOMPTEUR = pDemande.LaDemande.FK_IDREGLAGECOMPTEUR);
        //            _LeCompteur.ForEach(t => t.DEPOSE = null);
        //            _LeCompteur.ForEach(t => t.DATECREATION  = System.DateTime.Now );
        //        }
        //        List<EVENEMENT> _LstEvenement = new List<EVENEMENT>();
        //        if (pDemande.LstEvenement != null)
        //        {
        ...
        //            string MaxPeriode = string.Empty;
        //            int MaxNum = 0;
        //            List<EVENEMENT> levtMax = contextinter.EVENEMENT.Where (p => p.CENTRE == _LeAG.CENTRE && p.CLIENT == _LeAG.CLIENT && p.FK_IDCENTRE == pDemande.Transfert.FK_IDCENTRETRANSFERT).OrderByDescending(p=>p.PERIODE ).ToList();
        //            if (levtMax != null && levtMax.Count != 0)
        //            {
        //                MaxPeriode = levtMax.FirstOrDefault().PERIODE;
        //                MaxNum = levtMax.Max(p => p.NUMEVENEMENT);
        //                _LstEvenement = _LstEvenement.Where(t => int.Parse(t.PERIODE) > int.Parse(MaxPeriode)).ToList();
        //                foreach (EVENEMENT  item in _LstEvenement)
        //                {
        //                    MaxNum ++;
        //                    item.NUMEVENEMENT = MaxNum;
        ...
        //            if (leCompteClient != null && leCompteClient.Count != 0)
        //            {
        ...
        //            leCompteClient.ForEach(t => t.FK_IDCENTRE = pDemande.Transfert.FK_IDCENTRETRANSFERT);
        //            leCompteClient.ForEach(t => t.FK_IDCLIENT = fk_idclient);
        //            leCompteClient.ForEach(t => t.DATECREATION = DateTime.Now);
        //            leCompteClient.ForEach(t => t.ORDRE = OdreActif);
        //            Entities.InsertEntity<LCLIENT>(leCompteClient, pContext);

        //            _LeCompteur.ForEach(t => t.FK_IDABON = _LeAbon.PK_ID );
        //            _LeCompteur.ForEach(t => t.DEPOSE = null);
        //            _LeCompteur.ForEach(t => t.DATECREATION  = DateTime.Now );
        ...
        //                MaxPeriode = levtMax.FirstOrDefault().PERIODE;
        //                MaxNum = levtMax.Max(p => p.NUMEVENEMENT);
        //                var lst_periode_evt = _LstEvenement.Select(ev => ev.PERIODE).ToList();
        //                _LstEvenement = _LstEvenement.Where(t => (!string.IsNullOrWhiteSpace( t.PERIODE) && int.Parse(t.PERIODE) > int.Parse(MaxPeriode))).ToList();
        //                foreach (EVENEMENT item in _LstEvenement)
        //                {
        //                    MaxNum++;
        //                    item.NUMEVENEMENT = MaxNum;
        ...
        //            _LeClient.FK_IDAG = lag.PK_ID;
        //            _LeClient.ORDRE = OdreActif;
        //            pDemande.LeClient.ORDRE = OdreActif;
        //            Entities.InsertEntity<CLIENT>(_LeClient, pContext);


        //            _LeAbon.FK_IDCLIENT = _LeClient.PK_ID;
        //            _LeAbon.ORDRE = OdreActif;
        //            pDemande.Abonne.ORDRE = OdreActif;
        ...
        //                    item.DATECREATION = DateTime.Now;
        //                    item.FK_IDCANALISATION = _LeCompteur.FirstOrDefault(t => t.POINT == item.POINT).PK_ID;
        //                    item.FK_IDCENTRE = pDemande.Transfert.FK_IDCENTRETRANSFERT;
        //                }
        //            }
        //            Entities.InsertEntity<EVENEMENT>(_LstEvenement, pContext);
        //        }
        ...
        public static void FermerAncienAbonnement(CsDemande pDemande, galadbEntities pContext)
        {
            try
            {
                ...
                if (_LeAbonnement != null)
                {
                    _LeAbonnement.DRES = _LeAbonnement.DRES == null ? System.DateTime.Today : _LeAbonnement.DRES;
                    lstCanalisation = pContext.CANALISATION.Where(t => t.FK_IDABON == _LeAbonnement.PK_ID && t.DEPOSE == null).ToList();
                    foreach (CANALISATION item in lstCanalisation)
                        item.DEPOSE = System.DateTime.Today;
                }
        ...
        public static void MiseAjoursAbonBrtCreation(CsDemande pDemande, galadbEntities pContext)
        {
            try
            {
                ...
                foreach (var item_ in pDemande.LstCanalistion)
                {
                    ...
                    COMPTEUR leCompteur = contextinter.COMPTEUR.FirstOrDefault(t => t.NUMERO == item_.NUMERO && t.MARQUE ==item_.MARQUE  );
                    if (leCompteur != null && !string.IsNullOrEmpty(leCompteur.NUMERO))
                    {
                        CANALISATION laCana = contextinter.CANALISATION.FirstOrDefault(t => t.FK_IDCOMPTEUR == leCompteur.PK_ID);
                        if (laCana != null)
                        {
                            if (laCana.DEPOSE == null)
                            {
                                pDemande.LaDemande.MOTIF = "Ce compteur existe déja sur la reférence " + laCana.CENTRE + " " + laCana.CLIENT;
                                return;
                            }
                            else
                            {
                                lstcompteur.Add(leCompteur);
                                IsCompteurExiste = true;
                            }
                        }
                        else 
                          lstcompteur.Add(can);
                ...
                if (pDemande.LstCanalistion != null)
                {
                    ...
                    foreach (CsCanalisation item in pDemande.LstCanalistion)
                    {
                        ...
                        if (item.PRODUIT == Enumere.ElectriciteMT)
                        {
                            ...
                            leCan.FK_IDCOMPTEUR = lstcompteur.FirstOrDefault().PK_ID;
        ...
        public static bool? InsererCompteurEvtTransition(CsDemande pDemande, galadbEntities pContext)
        {
            try
            {
                ...
                foreach (EVENEMENT item in _LstEvenement.OrderByDescending(t => t.CAS))
                {
                    ...
                    if (item.CAS != Enumere.CasDeposeCompteur)
                        item.FK_IDCANALISATION = _LeCompteur.FirstOrDefault(t => t.POINT == item.POINT).PK_ID;
                    if(item.CAS!=Enumere.CasDeposeCompteur)
                        item.FK_IDCOMPTEUR = lstcompteur.FirstOrDefault().PK_ID;
                    ...
                    if (item.CAS != Enumere.CasDeposeCompteur)
                        item.FK_IDCOMPTEUR = leCompteurDuPoint.PK_ID;
                    item.PUISSANCE = _LeAbonnement.PUISSANCE;
                    item.TYPETARIF = _LeAbonnement.TYPETARIF;
                    lsEvtInsere.Add(new CsEvenement() { POINT = item.POINT, NUMEVENEMENT = nuEvt });
                }
                pDemande.LstEvenement.ForEach(c => c.FK_IDABON = IdAbon);
                Entities.InsertEntity<EVENEMENT>(_LstEvenement, pContext);
                pContext.SaveChanges();
                return true;
            }
