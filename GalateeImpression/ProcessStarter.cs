          ...
          public void Stop()
            {
                ...
                {
                    writeLog("Exception stop"+ex.Message);
                    throw ex;
                }
            }
            ...
            public int WaitForExit()
            {
               ...
               WaitForSingleObject(processInfo_.hProcess, INFINITE);
                ...
                catch (Exception ex)
                {
                    ...
                    throw;
                    writeLog("Exception waitforexit "+ex.Message);
                }
            }
            ...
            public void writeLog(string message)
            {
                try
                {
                    ...
                    using (StreamWriter sw = new StreamWriter(@"C:\Impression" + "\\LOG_" + date + ".txt", true))
                    {
